...
function initLegalModals() {
  ...
  const CONTENT = {
    privacy: {
      ...
      <p><strong>TIERRA NATIVA SA</strong><br>
      Correo electrónico: <a href="mailto:tierranativ@hotmail.com">tierranativ@hotmail.com</a><br>
      Teléfono: <a href="tel:+5491131181185">+54 9 11 3118 1185</a><br>
      Sitio web: <a href="http://tierravintage.com.ar/" target="_blank" rel="noopener">http://tierravintage.com.ar/</a></p>
      ...
      <p><strong>TIERRA NATIVA SA</strong> no comercializa ni cede datos personales a terceros con fines publicitarios.</p>
      ...
      El usuario se compromete a no difundir dicha información sin autorización expresa de <strong>TIERRA NATIVA SA</strong>.</p>
      ...
      <p><strong>TIERRA NATIVA SA</strong> implementa políticas de restricción de acceso a nivel de base de datos (Row Level Security), garantizando que cada usuario solo pueda acceder a la información asociada a su cuenta.</p>
      ...
      <p>mediante solicitud enviada a <a href="mailto:tierranativ@hotmail.com">tierranativ@hotmail.com</a>.</p>
      <p>La Agencia de Acceso a la Información Pública es el órgano de control en Argentina.</p>

      <hr>

      <h4>9. MODIFICACIONES</h4>
      <p><strong>TIERRA NATIVA SA</strong> podrá modificar la presente política en cualquier momento, publicando la versión actualizada en el sitio web.</p>`,
    },
    terms: {
      title: "Términos y Condiciones",
      html: `<p> Última actualización: <em>06/04/2026</em></p>
      ...
      <p><strong>TIERRA NATIVA SA</strong> se reserva el derecho de aprobar o rechazar solicitudes de registro.</p>
      ...
      <p>Todos los contenidos del sitio (marca, imágenes, textos, diseño, código) son propiedad de <strong>TIERRA NATIVA SA</strong>.
      Se prohíbe su reproducción sin autorización escrita.</p>

      <hr>

      <h4>8. LIMITACIÓN DE RESPONSABILIDAD</h4>
      <p><strong>TIERRA NATIVA SA</strong> no será responsable por:</p>
      <ul>
