...
// 2FA por email para el admin PPP (CUIT 30-71030536-2).
...
//
// ---------------------------------------------------------------------------
// NOTA DE VERSIONADO (2026-07-21)
// Esta funcion estaba desplegada en Supabase pero su fuente NO estaba en este
// repo. Se recupero via get_edge_function y se versiona aca para que el codigo
...
//
// PENDIENTE DE DESPLIEGUE. Hasta que se redespliegue, el codigo 2FA sigue
// llegando a loekemeyer.n8n@gmail.com.
// ---------------------------------------------------------------------------
...
<html><body style="margin:0;padding:24px;background:#f5f5f5;font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;color:#222">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:14px;padding:32px;border:1px solid #e6e6e6">
    <div style="text-align:center;margin-bottom:20px">
      <div style="display:inline-block;background:#212122;color:#fff;width:48px;height:48px;border-radius:12px;line-height:48px;font-weight:800;letter-spacing:1px">TN</div>
    </div>
    <h2 style="margin:0 0 8px;font-size:20px;text-align:center">Código de acceso al panel admin</h2>
    <p style="color:#666;margin:0 0 24px;font-size:13.5px;text-align:center">Tierra Nativa SA — Panel Administrador</p>
    ...
    if (action === "send") {
      ...
      const mailRes = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          from: resendFrom,
          to: [RECIPIENT_EMAIL],
          subject: "Código de acceso - Admin Tierra Nativa",
